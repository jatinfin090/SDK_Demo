...
class CheckEligibilityViewModelww(private val loanSdkLandingPageRepository: LoanSdkLandingPageRepository) :
    BaseViewModel() {
    ...
    fun loanSdkRegisterUSer(
        loanSdkRegisterRequest: LoanSdkRegisterUserRequest,
        dataStoreManager: DataStoreManager
    ) {

        viewModelScope.launch {

            loanSdkLandingPageRepository.loanSdkRegisterUSer(loanSdkRegisterRequest)
                .collect { response ->
                    when (response) {
...
fun collectDOB(){
    ...
    sealed class Event {
        ...
        data class saveUserResponse(val message: String) : Event()
